...
public class JwtAuthenticationProvider implements JwtProvider {
    ...
    public Authentication validate(String token) {
        ...
        GrantedAuthority a = new SimpleGrantedAuthority(String.valueOf(claims.get("role")));
        Authentication auth = new UsernamePasswordAuthenticationToken(email, null, List.of(a));
        return auth;
    }
}
